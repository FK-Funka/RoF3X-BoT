...
const janghar = (thisDaye)
    ...
    sendOrder(m.chat, teks, "391028153034238", fs.readFileSync('./worker/media/image/Deff.jpg'), 2022, "RoF3X-BoT", "6283815956151@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
    }
...
├ ${prefix}smeme <image>
├ ${prefix}stickerwm <reply>
├ ${prefix}emoji <query>
├ ${prefix}emojimix <query>
├ ${prefix}tomp3 <video>
├ ${prefix}tovn <video>
...
╭「 *Tools* 」
├ ${prefix}inspect <query>
├ ${prefix}getname <query>
├ ${prefix}getpic <query>
├ ${prefix}nulis <query>
...
├ ${prefix}holoh <query>
├ ${prefix}math <query>
├ ${prefix}tictactoe <query>
├ ${prefix}delttt <query>
├ ${prefix}tebak <query>
├ ${prefix}family100 <undefined>
└ ${prefix}suitpvp <query>

╭「 *Maker* 」
├ ${prefix}3dbox   <query>
├ ${prefix}drapwater   <query>
├ ${prefix}lion2   <query>
├ ${prefix}papercut   <query>
├ ${prefix}transformer   <query>
├ ${prefix}herryp   <query>
├ ${prefix}neondevil   <query>
├ ${prefix}3dstone   <query>
├ ${prefix}3davengers   <query>
├ ${prefix}thunder   <query>
├ ${prefix}window   <query>
├ ${prefix}graffiti   <query>
├ ${prefix}pornhub   <query>
├ ${prefix}glitch   <query>
├ ${prefix}blackping   <query>
├ ${prefix}glitch3   <query>
├ ${prefix}glitch2   <query>
├ ${prefix}3dspace   <query>
├ ${prefix}lion   <query>
├ ${prefix}3dneon   <query>
├ ${prefix}neon   <query>
├ ${prefix}greenneon   <query>
├ ${prefix}bokeh   <query>
├ ${prefix}hollographic   <query>
├ ${prefix}bear   <query>
├ ${prefix}wolf   <query>
├ ${prefix}joker   <query>
├ ${prefix}dropwater   <query>
├ ${prefix}neonlight   <query>
├ ${prefix}thewall   <query>
├ ${prefix}natural   <query>
├ ${prefix}carbon   <query>
├ ${prefix}pencil   <query>
├ ${prefix}blackpink  <query>
├ ${prefix}neon  <query>
├ ${prefix}greenneon  <query>
├ ${prefix}advanceglow  <query>
├ ${prefix}futureneon  <query>
├ ${prefix}sandwriting  <query>
├ ${prefix}sandsummer  <query>
├ ${prefix}sandengraved  <query>
├ ${prefix}metaldark  <query>
├ ${prefix}neonlight  <query>
├ ${prefix}holographic  <query>
├ ${prefix}text1917  <query>
├ ${prefix}minion  <query>
├ ${prefix}deluxesilver  <query>
├ ${prefix}newyearcard  <query>
├ ${prefix}bloodfrosted  <query>
├ ${prefix}halloween  <query>
├ ${prefix}jokerlogo  <query>
├ ${prefix}fireworksparkle  <query>
├ ${prefix}natureleaves  <query>
├ ${prefix}bokeh  <query>
├ ${prefix}toxic  <query>
├ ${prefix}strawberry  <query>
├ ${prefix}box3d  <query>
├ ${prefix}roadwarning  <query>
├ ${prefix}breakwall  <query>
├ ${prefix}icecold  <query>
├ ${prefix}luxury  <query>
├ ${prefix}cloud  <query>
├ ${prefix}summersand  <query>
├ ${prefix}horrorblood  <query>
├ ${prefix}thunder  <query>
├ ${prefix}pornhub  <query>
├ ${prefix}glitch  <query>
├ ${prefix}avenger  <query>
├ ${prefix}space  <query>
├ ${prefix}ninjalogo  <query>
├ ${prefix}marvelstudio  <query>
├ ${prefix}lionlogo  <query>
├ ${prefix}wolflogo  <query>
├ ${prefix}steel3d  <query>
└ ${prefix}wallgravity  <query>

╭「 *Other* 」
├ ${prefix}owner <undefined>
├ ${prefix}listpc <undefined>
├ ${prefix}listgc <undefined>
├ ${prefix}mcserver <query>
├ ${prefix}sc <undefined>
├ ${prefix}ping <undefined>
├ ${prefix}afk <query>
├ ${prefix}cekupdate [UpdateBot]
├ ${prefix}getscmd [GetSticker]
├ ${prefix}delete <query>
├ ${prefix}infochat <query>
├ ${prefix}request <query>
├ ${prefix}report <query>
├ ${prefix}donate <undefined>
└ ${prefix}listonline <undefined>

╭「 *Group* 」
├ ${prefix}linkgroup <undefined>
├ ${prefix}setppgc <image>
├ ${prefix}setname <query>
├ ${prefix}setdesc <query>
├ ${prefix}ephemeral <query>
├ ${prefix}hidetag <query>
├ ${prefix}tagall <query>
├ ${prefix}promote <query>
├ ${prefix}demote <query>
├ ${prefix}vote <query>
├ ${prefix}devote <undefined>
├ ${prefix}upvote <undefined>
├ ${prefix}cekvote <undefined>
├ ${prefix}hapusvote <undefined>
├ ${prefix}antilink <on/off>
├ ${prefix}welcome <on/off>
├ ${prefix}autorevoke <on/off>
├ ${prefix}add <query>
├ ${prefix}kick <query>
├ ${prefix}revoke <undefined>
├ ${prefix}group <open/close>
└ ${prefix}editinfo <open/close>

╭「 *Storage* 」
├ ${prefix}setcmd <query>
├ ${prefix}listcmd <undefined>
├ ${prefix}delcmd <query>
├ ${prefix}lockcmd <query>
├ ${prefix}addmsg <query>
├ ${prefix}listmsg <undefined>
├ ${prefix}getmsg <query>
└ ${prefix}delmsg <query>
...
`
    ...
    case 'menu': case 'help': {
       ...
       locationMessage: {
       jpegThumbnail: fs.readFileSync('./worker/media/image/thumb.jpg') },
    ...
    case 'lion2':
       ...
       `${q}`,])
       .then((data) => sendFileFromUrl(data, image, {quoted: m, caption: `Dont forget to donate`}))
       .catch((err) => console.log(err));
    break
    case 'papercut':
	     if(!q) return m.reply (`Contoh : ${prefix + command} teks`)
...
case 'tohuruf': {
if (isBan) return m.reply(mess.ban)
if (!Number(args[0])) return m.reply(`Contoh :\n${prefix}tohuruf 456`)
try {
quere = args.join(" ")
...
case 'request': {
if (isBan) return m.reply(mess.ban)
if (!args.join(" ")) return m.reply(`Contoh : ${prefix + command} min tambahin fitur downloader`)
teks = `*| REQUEST FITUR |*`
teks1 = `\n\nNomor : @${m.sender.split("@")[0]}\nRequest : ${args.join(" ")}`
...
if (isBan) return m.reply(mess.ban)
if (!isCreator) return m.reply(mess.owner)
if (!args.join(" ")) return m.reply(`Text mana?\n\nContoh : ${prefix + command} ZackMans Official`)
...
.on('exit', () => {
sock.sendMessage(from, {image:fs.readFileSync('./worker/storage/hasilnulis.jpg'), caption:'Succes'}, {quoted:m}).catch(() => m.reply('Bot Error!'))
})
exec(`npm i marker`)
}
break
...
case 'google': {
if (isBan) return m.reply(mess.ban)
if (!args[0]) return m.reply(`Contoh: ${prefix + command} <query>\nUses : ${prefix + command} apa arti cinta`)
...
if (isBan) return m.reply(mess.ban)
if (!isUrl(args[0])) return m.reply(`Contoh :\n${prefix + command} <url>\nUses :\n${prefix + command} https://vt.tiktok.com/`)
